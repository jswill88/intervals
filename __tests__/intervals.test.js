...
describe('Errors', () => {
  ...
  expect(() => interval(4, 'P4')).toThrowError('Note and interval arguments must be strings');
  expect(() => interval('Bb', {})).toThrowError('Note and interval arguments must be strings');
